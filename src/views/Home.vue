...
<!--            <div class="separation-line"></div>-->
            <div class="about">
              <div class="home-information">
                ...
                <div  class="home-information-picture">
...
<!--                  <div class="company-wrapper"><span class="company">{{ event.institution }}</span></div>-->
        ...
        data () {
          return {
            timeline: [
              ...
              {classes: "", institution: "Het Vlaams Energieagentschap - VO", title: "Energy Resources Analysis", date: "2018 - 2019", description: "The goal of this project is to perform a data analysis for VEA and to discover new insights on the current state of Belgian housing based on a data-driven approach."},
              {classes: "", institution: "Het Facilitair Bedrijf - VO", title: "Data Pipelines on AWS", date: "2018 - 2019", description: "I took part in implementing and automating data flows for assets management of Het Facilitair Bedrijf - VO. I built several data pipeline flows which involve getting data from APIs, applying ETL on them and storing them in Amazon RDS databases."},
              {classes: "", institution: "VDAB", title: "Data Science & Machine Learning ", date: "2018 - 2019", description: "During my internship in Innovation Lab of VDAB, I had the chance to take a part in Next Best Steps (Kans op Werk) project, which is a large-scale project developed by a large team of data science/engineering experts."},
